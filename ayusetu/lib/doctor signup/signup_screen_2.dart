import 'package:ayusetu/doctor%20signup/signup_screen_3.dart';
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isFormValid
                    ? () {
                        final doctorName = nameController.text.trim().replaceFirst("Dr ", ""); // Remove "Dr" prefix if present
                        final phoneNumber = "+91${phoneController.text.trim()}"; // Ensure phone number starts with +91
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DoctorSignupScreen3(
                              doctorName: doctorName, // Pass Doctor's Name (without "Dr")
                              phoneNumber: phoneNumber, // Pass phone number with +91
